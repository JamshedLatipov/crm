    ...
    >
      ...
      @if (templates().length === 0) {
        <div class="empty-state">
          ...
          <h3>Нет шаблонов</h3>
          <p>Создайте первый Email шаблон для использования в кампаниях</p>
          <button mat-raised-button color="primary" routerLink="/notifications/email-templates/new">
            <mat-icon>add</mat-icon>
            Создать шаблон
          </button>
          ...
          <div class="table-wrapper">
            <table mat-table [dataSource]="templates()" class="modern-table">
              ...
              <ng-container matColumnDef="subject">
                <th mat-header-cell *matHeaderCellDef>Тема письма</th>
                <td mat-cell *matCellDef="let template">
                  <div class="subject-preview">{{ template.subject }}</div>
                </td>
              </ng-container>
