        ...
        <div class="header-content">
          ...
          <div class="header-text">
            ...
            <p class="dialog-subtitle">
              {{ data.deal?.title || data.task?.title }}
            </p>
          </div>
        </div>
            ...
            <mat-list-option
              *ngFor="let user of filteredUsers"
              ...
              [class.current-assignee]="
                user.id ===
                (data.deal?.assignedTo || data.task?.assignedToId?.toString())
              "
            >
              <div class="user-item">
                ...
                <div class="user-info">
                  <div class="user-name">
                    ...
                    <span
                      *ngIf="
                        user.id ===
                        (data.deal?.assignedTo ||
                          data.task?.assignedToId?.toString())
                      "
                      class="current-badge"
                    >
                  ...
                  <div class="user-workload">
                    ...
                    <div
                      ...
                      [class.high]="
                        (user.workload ?? 0) > (user.maxCapacity ?? 0)
                      "
                    >
                      <div
                        class="workload-text"
                      ...
                      <div class="workload-bar">
                        <div
                          ...
                          [style.width.%]="
                            ...
                            ((user.workload ?? 0) / (user.maxCapacity || 1)) *
                              100
                          "
                          [class.warning]="
                            (user.workload ?? 0) > (user.maxCapacity ?? 0)
                    ...
                    <div
                      class="workload-section"
                      [class.high]="
                        (user.currentDealsCount ?? 0) >
                        (user.maxDealsCapacity ?? 0)
                      "
                    >
                      <div
                        class="workload-text"
                        ...
                        "
                      >
                        Сделок: {{ user.currentDealsCount ?? 0 }} /
                        {{ user.maxDealsCapacity ?? 0 }}
                      </div>
                      <div class="workload-bar">
                        <div
                    ...
                    <div
                      class="workload-section"
                      [class.high]="
                        (user.currentTasksCount ?? 0) >
                        (user.maxTasksCapacity ?? 0)
                      "
                    >
                      <div
                        class="workload-text"
                        ...
                        "
                      >
                        Задач: {{ user.currentTasksCount ?? 0 }} /
                        {{ user.maxTasksCapacity ?? 0 }}
                      </div>
                      <div class="workload-bar">
                        <div
