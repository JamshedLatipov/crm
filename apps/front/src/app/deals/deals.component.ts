          ...
          <div class="filters-card">
            <div class="filters-grid">
              <app-status-tabs
                ...
                (selectedChange)="onStatusTabChange($event)"
              ></app-status-tabs>
              ...
              <mat-form-field appearance="outline" class="search-field">
                ...
                <input
                  ...
                  placeholder="По названию, контакту, компании"
                />
...
export class DealsComponent implements OnInit {
  ...
  loadDeals() {
    ...
    this.dealsService
      .listDeals(backendPage, this.pageSize, {
      ...
      .subscribe({
        next: (res) => {
          ...
          const data: Deal[] = Array.isArray(res)
            ? res
            : (res as any).items || [];
          const totalFromBackend: number | undefined = Array.isArray(res)
            ? undefined
            : (res as any).total;
          ...
          this.totalResults =
            typeof totalFromBackend === 'number' ? totalFromBackend : undefined;
