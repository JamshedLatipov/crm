...
export class AddWebRtcOperator11691337601001 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('[migration] AddWebRtcOperator1 up starting');
    ...
    `);
    console.log('[migration] AddWebRtcOperator1 inserted ps_aors');
    ...
    `);
    console.log('[migration] AddWebRtcOperator1 inserted ps_auths');
    ...
    await queryRunner.query(`
      ...
      SET
        ...
        rtp_symmetric = 'yes';
    `);
    console.log('[migration] AddWebRtcOperator1 inserted ps_endpoints');
  }
